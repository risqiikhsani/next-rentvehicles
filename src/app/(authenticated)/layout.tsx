...
const LINKS_ADMIN = [
  { text: "Home", href: "/app", icon: HomeIcon },
  { text: "My Posts", href: "/app/myposts", icon: ChecklistIcon },
  { text: "Bookings order", href: "/app/bookings-order", icon: StarIcon },
  { text: "Rents order", href: "/app/rents-order", icon: StarIcon },
  { text: "Statistic", href: "/app/statistic", icon: ChecklistIcon },
];
